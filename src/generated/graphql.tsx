...
export type GetArtistQuery = { __typename?: 'Query' } & {
  getArtist: { __typename?: 'Artist' } & Pick<
    Artist,
    'pid' | 'name' | 'website' | 'imageUrl' | 'imageSetUrl' | 'base64' | 'labelSide'
  > & {
      ...
      bandMembers?: Maybe<
        Array<
          { __typename?: 'BandMember' } & Pick<
            BandMember,
            'name' | 'imageUrl' | 'imageSetUrl' | 'base64' | 'instrument'
          >
        >
      >
      albums?: Maybe<
        ...
        albums?: Maybe<
          Array<
            { __typename?: 'Album' } & Pick<
              Album,
              'name' | 'year' | 'imageUrl' | 'imageSetUrl' | 'base64'
            > & {
                links: { __typename?: 'AlbumLink' } & Pick<
                  AlbumLink,
                  'website' | 'youtube' | 'spotify' | 'soundCloud' | 'appleMusic'
...
export type GetNewsItemQuery = { __typename?: 'Query' } & {
  getNewsItem: { __typename?: 'NewsItem' } & Pick<
    NewsItem,
    'pid' | 'title' | 'shortTitle' | 'imageUrl' | 'imageSetUrl' | 'base64' | 'description' | 'date'
  > & {
      videos?: Maybe<Array<{ __typename?: 'Video' } & Pick<Video, 'src' | 'title'>>>
...
export type GetCartQuery = { __typename?: 'Query' } & {
  getCart: Array<
    { __typename?: 'CartItem' } & Pick<CartItem, 'pid' | 'shopPid' | 'size' | 'color' | 'qty'> & {
        shopItem: { __typename?: 'ShopItemTrimmed' } & Pick<ShopItemTrimmed, 'name' | 'price'> & {
            images: Array<
              { __typename?: 'ShopImage' } & Pick<
                ShopImage,
                'imageUrl' | 'imageSetUrl' | 'base64' | 'alt' | 'color'
              >
            >
          }
      }
...
export type RemoveFromCartMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'removeFromCart'>
    ...
    { __typename?: 'Order' } & Pick<Order, 'pid' | 'amount' | 'date'> & {
        items: Array<
          { __typename?: 'OrderShopItem' } & Pick<
            OrderShopItem,
            'shopPid' | 'qty' | 'purchasePrice' | 'color' | 'size'
          > & {
              shopItem: { __typename?: 'ShopItemTrimmed' } & Pick<ShopItemTrimmed, 'name'> & {
                  images: Array<
                    { __typename?: 'ShopImage' } & Pick<
                      ShopImage,
                      'imageUrl' | 'imageSetUrl' | 'base64' | 'alt' | 'color'
