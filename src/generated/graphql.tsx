...
export type GetArtistQuery = (
  ...
  & { getArtist: (
    { __typename?: 'Artist' }
    & Pick<Artist, 'pid' | 'name' | 'website' | 'imageUrl' | 'labelSide'>
    & { introduction: (
      { __typename?: 'Intro' }
      & Pick<Intro, 'header' | 'body'>
    ), bandMembers?: Maybe<Array<(
      { __typename?: 'BandMember' }
      & Pick<BandMember, 'name' | 'imageUrl' | 'instrument'>
    )>>, albums?: Maybe<Array<(
      { __typename?: 'Album' }
      & Pick<Album, 'name' | 'year' | 'imageUrl'>
      & { links: (
        { __typename?: 'AlbumLink' }
...
export type GetNewsItemQuery = (
  ...
  & { getNewsItem: (
    { __typename?: 'NewsItem' }
    & Pick<NewsItem, 'pid' | 'title' | 'shortTitle' | 'imageUrl' | 'description' | 'date'>
    & { videos?: Maybe<Array<(
      { __typename?: 'Video' }
      & Pick<Video, 'src' | 'title'>
    )>>, links?: Maybe<Array<(
