...
const AboutUs: React.FC = () => {
  ...
  return (
    <Layout pageType="main">
      ...
      <TertiaryHeader>
        We partner with artists in the same way that other labels don’t. We align our goals with the
        artists’ goals and measure our success on achieving those mutual goals.
      </TertiaryHeader>
      <TextBody center>
        Additionally, we take a different approach to marketing. Our contact list is extensive and
        has global reach, covering every landmass on Earth, but that’s not the only thing that sets
        us apart. By engaging each contact individually we’re able to create and maintain rapport.
        Building upon these relationships allows us to establish the long term partnerships that
        form the foundation of our marketing.
      </TextBody>
      <SecondaryHeader>
